...
def main():
    ...
    if DOWNLOAD_FROM_FIRMS == True:
        urls = [
                "https://firms2.modaps.eosdis.nasa.gov/data/active_fire/modis-c6.1/kml/MODIS_C6_1_Russia_Asia_24h.kml",
                "https://firms2.modaps.eosdis.nasa.gov/data/active_fire/suomi-npp-viirs-c2/kml/SUOMI_VIIRS_C2_Russia_Asia_24h.kml",
                "https://firms2.modaps.eosdis.nasa.gov/data/active_fire/noaa-20-viirs-c2/kml/J1_VIIRS_C2_Russia_Asia_24h.kml"
                ]
